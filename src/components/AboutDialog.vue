  ...
  <div v-if="isOpen" class="modal-overlay" @click="closeModal">
    <div class="modal-content" @click.stop>
      ...
      <div class="about-header">
        ...
        <h2>Audio Konverter</h2>
        <p class="version">Version 2.0.0</p>
        <p class="copyright">© 2024 Kodini Tools</p>
      </div>
        ...
        <section class="section">
          ...
          <div class="license-list">
            ...
            <div class="license-item">
              ...
              <span>Font Awesome Free License</span>
            ...
            <div class="license-item">
              <strong>JSZip, Axios, Pinia</strong>
              <span>MIT License</span>
            </div>
          </div>

          <button class="btn-secondary" @click="openLicenses">
...
async function openLicenses() {
  // In Electron: Try to open LICENSES.txt from resources
  if (window.electronAPI && window.electronAPI.isElectron) {
    try {
      // In Electron, we'll open it from the app resources
      // The file should be in the app.asar or resources folder
      const licensesUrl = window.location.origin + '/LICENSES.txt'
      window.open(licensesUrl, '_blank')
    } catch (error) {
      console.error('Could not open LICENSES.txt:', error)
      // Fallback: Show inline
      alert('LICENSES.txt konnte nicht geöffnet werden. Bitte prüfen Sie die Installationsdatei.')
    }
  } else {
    // Web: Open licenses in new tab or download
    window.open('/audiokonverter/LICENSES.txt', '_blank')
  }
}
